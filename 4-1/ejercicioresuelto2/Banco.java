      ...
      switch (requestIntInput("Ingrese el numero segun el comando que desea realizar: ")) {
        ...
        case 3:
          ...
          switch (type.toLowerCase()) {
            case "persona":
              if (buscarCliente(Personas, cPer, nombre) != null) {
                buscarCliente(Personas, cPer, nombre).getInfo();
              }
              break;
            case "empresa":
              if (buscarCliente(Empresas, cEmp, nombre) != null) {
                buscarCliente(Empresas, cEmp, nombre).getInfo();
              }
              break;
            case "estudiante":
              if (buscarCliente(Estudiantes, cEst, nombre) != null) {
                buscarCliente(Estudiantes, cEst, nombre).getInfo();
              }
              break;
            default:
        ...
        case 4:
          ...
          switch (type.toLowerCase()) {
            case "persona":
              if (buscarCliente(Personas, cPer, nombre) != null) {
                Persona Pers = (Persona)buscarCliente(Personas, cPer, nombre);
            ...
            case "empresa":
              if (buscarCliente(Empresas, cEmp, nombre) != null) {
                Empresa Empr = (Empresa)buscarCliente(Empresas, cEmp, nombre);
            ...
            case "estudiante":
              if (buscarCliente(Estudiantes, cEst, nombre) != null) {
                Estudiante Estu = (Estudiante)buscarCliente(Estudiantes, cEst, nombre);
